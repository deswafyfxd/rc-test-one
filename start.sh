...
if [ "${DARK_MODE,,}" = "true" ]; then
    CMD="${CMD} --template=templates/dark1.html --template=templates/dark2.html --template=templates/dark3.html --template=templates/dark4.html --template=templates/dark5.html --template=templates/dark6.html --template=templates/dark7.html --template=templates/dark8.html --template=templates/dark9.html --template=templates/dark10.html"
